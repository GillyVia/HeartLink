...
export default function LaporGejala() {
  ...
  const handleSubmit = (data: number[], scoreVal: number) => {
    let risk = "Rendah";
  ...
  return (
    <div className="min-h-screen bg-[#EAF3EF] flex flex-col items-center py-8 px-4">
      ...
      <div className="bg-[#A9CDBB] relative rounded-[30px] p-6 w-full max-w-5xl shadow-lg overflow-hidden">
        ...
        {/* PROGRESS BACK */}
        <div className="absolute top-0 left-0 w-full h-6 bg-gray-200 rounded-t-[30px] pointer-events-none" />

        {/* PROGRESS FILL */}
        <motion.div
          className={`absolute top-0 left-0 h-6 bg-gradient-to-r ${riskColor} rounded-t-[30px] pointer-events-none`}
        ...
        >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* === PERTANYAAN (SUDAH DI-BOLD + CLEAR) === */}
